...
class Googlemaps {
	...
	var $center						= "41.7102767, 44.7892072";		// Sets the default center location (lat/long co-ordinate or address) of the map. If defaulting to the users location set to "auto"
